import 'package:appbar/screen/tablet/custom_project_card_tablet.dart';
import 'package:flutter/material.dart';

class FeaturedWorkTabletSection extends StatelessWidget {
  FeaturedWorkTabletSection({super.key});
    ...
    return ListView.builder(
      ...
      itemCount: _post.length,
        itemBuilder: (context, index) {
          return CustomProjectCardTablet(
